...
function ba_bc_class() {
    ...
    var ba_bc_click_tracker_for_300x600_ad = 'https://www.facebook.com/ThatAwkwardMomentMovie'; //For example: http://blogads.com/
    var ba_bc_impression_tracker_for_300x600_ad = 'http://skins.blogads.com/blogads/blank.gif?v=' + ba_bc_rand; //For example: 'http://skins.blogads.com/blogads/blank.gif?rand=' + ba_bc_rand
    ...
    if (typeof (window.ba_bc_sov) == 'undefined') {
        window.ba_bc_sov_paid = 4; //The SOV of paid part of the campaign.
        window.ba_bc_sov_added = 2;  //The SOV of free part of the campaign.
...
#ba_bc_list_loading img {vertical-align: middle;}\n\
    ...
    this.ba_bc_show_300x600 = function() {
        if (window.ba_bc_already_running)
            ...
            //Added value.
            if (window.ba_bc_branded_content_rand > window.ba_bc_sov_paid &&
                    window.ba_bc_branded_content_rand <= window.ba_bc_sov &&
                    this.ba_bc_is_it_preview_page() === false &&
                    this.ba_bc_is_it_needed_post_page() === false) {
                ba_bc_default_tracer_id_suffix = 'added';
                ba_bc_default_tracer_id = ba_bc_default_tracer_id_prefix + '_' + ba_bc_default_tracer_id_suffix;
            }
        }
